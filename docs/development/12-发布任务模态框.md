...
> 最新说明：第 16 章已经将“任务描述”从 `Textarea` 升级为 Tiptap 富文本编辑器。第 18 章已经将“手工填写附件 ID”升级为“选择文件后立即上传”。阅读当前最新代码时，任务描述请以 `RichTextEditor` / `RichTextViewer` 为准，附件请以 `TaskAttachmentUploader` 为准。
