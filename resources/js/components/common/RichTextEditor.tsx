    ...
    return (
        <div className="rounded-md border border-[#d1d5db] bg-white focus-within:border-[#5e6ad2] focus-within:ring-2 focus-within:ring-[#5e6ad2]/15">
            <div className="flex flex-wrap items-center gap-1 border-b border-[#eef0f3] bg-[#fbfbfc] px-2 py-1.5">
                ...
                >
                    <Bold className="size-[26px]" strokeWidth={2.6} />
                </ToolbarButton>
                <ToolbarButton
                ...
                >
                    <Italic className="size-[26px]" strokeWidth={2.6} />
                </ToolbarButton>
                <ToolbarButton
                ...
                >
                    <List className="size-[26px]" strokeWidth={2.6} />
                </ToolbarButton>
                <ToolbarButton
                ...
                >
                    <ListOrdered className="size-[26px]" strokeWidth={2.6} />
                </ToolbarButton>
                <ToolbarButton
                    ...
                    onClick={setLink}
                >
                    <Link2 className="size-[26px]" strokeWidth={2.6} />
                </ToolbarButton>
            </div>
