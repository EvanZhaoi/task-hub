...
function ToolbarButton({ active = false, disabled = false, label, onClick, children }: ToolbarButtonProps) {
    return (
        <Button
            aria-label={label}
            className={cn(
                'size-10 border border-transparent bg-transparent px-0 text-[#1f2937] shadow-none hover:bg-[#f3f4f6] hover:text-[#111827]',
    ...
    return (
        <div className="rounded-md border border-[#cbd5e1] bg-white shadow-sm focus-within:border-[#5e6ad2] focus-within:ring-2 focus-within:ring-[#5e6ad2]/15">
            <div className="flex flex-wrap items-center gap-1 rounded-t-md border-b border-[#e5e7eb] bg-[#f8fafc] px-2 py-1.5">
                ...
                >
                    <Bold className="size-7" strokeWidth={2.75} />
                </ToolbarButton>
                <ToolbarButton
                ...
                >
                    <Italic className="size-7" strokeWidth={2.75} />
                </ToolbarButton>
                <ToolbarButton
                ...
                >
                    <List className="size-7" strokeWidth={2.75} />
                </ToolbarButton>
                <ToolbarButton
                ...
                >
                    <ListOrdered className="size-7" strokeWidth={2.75} />
                </ToolbarButton>
                <ToolbarButton
                    ...
                    onClick={setLink}
                >
                    <Link2 className="size-7" strokeWidth={2.75} />
                </ToolbarButton>
            </div>
